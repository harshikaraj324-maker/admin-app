...
import { ArrowLeft, RefreshCw, Trash2, Smartphone, Wifi, Search, Radio } from "lucide-react";
...
export default function AppDetail({ app, onBack }: AppDetailProps) {
  ...
  // Only real devices (no admin_* system entries)
                    ...
                    <div key={d.sub_id}
                      ...
                      <div className="flex items-start gap-2.5">
                        <div className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 ${
                          ...
                          <Smartphone className={`w-4 h-4 ${statusV === "online" ? "text-emerald-400" : "text-slate-500"}`} />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 flex-wrap">
